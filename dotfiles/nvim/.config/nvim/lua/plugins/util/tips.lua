return {
  ...
  init = function()
    ...
    map("n", "<leader>nb", ":NeovimTipsBookmarks<CR>", { desc = "Bookmarked tips", silent = true })
    map("n", "<leader>ne", ":NeovimTipsEdit<CR>", { desc = "Edit your Neovim tips", silent = true })
    map("n", "<leader>na", ":NeovimTipsAdd<CR>", { desc = "Add your Neovim tip", silent = true })
    map("n", "<leader>nh", ":help neovim-tips<CR>", { desc = "Neovim tips help", silent = true })
