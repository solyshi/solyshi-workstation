return {
    ...
    config = function()
        -- Keymaps
        vim.keymap.set("n", "<leader>bc", "<cmd>CMakeClean<cr>", { desc = "Clean Project" })
        vim.keymap.set("n", "<leader>bb", "<cmd>CMakeBuild<cr>", { desc = "Build Project" })
        vim.keymap.set("n", "<leader>bg", "<cmd>CMakeGenerate<cr>", { desc = "Generate Project" })
        vim.keymap.set("n", "<leader>br", "<cmd>CMakeRun<cr>", { desc = "Run Project" })
